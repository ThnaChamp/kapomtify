                  ...
                  <tr key={alb.album_id} className="hover:bg-[#2a2a2a] transition-colors h-[64px] group">
                    ...
                    <td className="px-6 py-3 text-right">
                      <div className="flex gap-2 justify-end">
                        <button onClick={() => navigate(`/albums/${alb.album_id}`)} className="px-3 py-1 bg-[#252525] border border-[#444] rounded text-[11px] text-gray-300 hover:bg-[#333]">Detail</button>
